...
Our assisted living facility offers a comprehensive range of features, including safety and security around the clock, deeply personalized care, respectful treatment for all residents, regular communication with families, and unparalleled value for money.
    ...
    <section class="text-gray-600  body-font">
      <div
        class="container mx-auto flex px-5 mb-16 md:flex-row flex-col items-center"
      >
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10  md:mb-0">
          <img
            class="object-center rounded"
            alt="hero"
            src="../assets/Images//GoldenAge.webp"
          />
        </div>
        ...
        >
          <h1
            class="title-font  sm:text-4xl text-3xl -mt-10 mb-4 font-medium text-gray-900"
          >
            Excellent Rooms with Individual Caretakers
          </h1>
          <p class="mb-4 leading-relaxed">
            We periodically train and supervise the performance of our ayahs,
            caregivers, attendants etc. for consistently high quality of all the
            services that we offer Accommodation options to suit everyone.
          </p>
          ...
          <div class="flex mt-2">
            ...
            <p class="ml-2">
                Twin-sharing Rooms (One attendant for Two)
            </p>
          </div>
        </div>
      </div>
...
<div class="flex mt-2">
          ...
          <div class="flex mt-2">
            ...
            <p class="ml-2">
                Telephone for Outgoing callings
            </p>
          </div>
    ...
    <div class="flex flex-col md:w-1/2 md:pl-12">
      ...
      <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
          <img
            class="object-center w-3/4 rounded"
            alt="hero"
